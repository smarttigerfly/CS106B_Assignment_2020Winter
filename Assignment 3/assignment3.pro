...
#SOURCES         *=  $$files(Inverse Genetics/*.cpp, true)
#SOURCES         *=  $$files(Karel Goes Home/*.cpp, true)
#SOURCES         *=  $$files(Random Subsets/*.cpp, true)
#SOURCES         *=  $$files(Sierpinski/*.cpp, true)
#SOURCES         *=  $$files(Subsequences/*.cpp, true)
#SOURCES         *=  $$files(Universal Health Care/*.cpp, true)
HEADERS         *=  $$files(*.h, true)
#HEADERS         *=  $$files(Inverse Genetics/*.h, true)
#HEADERS         *=  $$files(Karel Goes Home/*.h, true)
#HEADERS         *=  $$files(Random Subsets/*.h, true)
#HEADERS         *=  $$files(Sierpinski/*.h, true)
#HEADERS         *=  $$files(Subsequences/*.h, true)
#HEADERS         *=  $$files(Universal Health Care/*.h, true)
