...
struct DataPoint {
    ...
    /* These functions are used by our debugging harness to help you flag errors
     * that arise from mixing up delete and delete[]. You shouldn't need to call
    ...
    /* This is used to track allocations of DataPoint objects. You should not need
     * to reference this field.
     */
    static int theAllocationTracker;
};
...
/* This is used by our test suite to let you check for memory leaks. */
